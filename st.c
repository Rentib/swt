...
size_t ttyread(void)
{
	...
	switch (ret) {
	case 0:  exit(0); /* TODO: this should set running to false */
...
void csiparse(void)
{
	...
	while (p < csiescseq.buf + csiescseq.len) {
		...
		if (*p != sep || csiescseq.narg == ESC_ARG_SIZ) break;
		p++;
	}
	csiescseq.mode[0] = *p++;
...
int32_t tdefcolor(const int *attr, int *npar, int l)
{
	...
	case 2: /* direct color in RGB space */
		...
		b = attr[*npar + 4];
		*npar += 4;
		if (!BETWEEN((int)r, 0, 255) || !BETWEEN((int)g, 0, 255) ||
		    !BETWEEN((int)b, 0, 255))
...
{
	switch (c) {
	case 0x90: /* DCS -- Device Control String */ c = 'P'; break;
	case 0x9f: /* APC -- Application Program Command */ c = '_'; break;
	case 0x9e: /* PM -- Privacy Message */ c = '^'; break;
	case 0x9d: /* OSC -- Operating System Command */ c = ']'; break;
	}
	strreset();
	strescseq.type = c;
	term.esc |= ESC_STR;
...
void tcontrolcode(uchar ascii)
{
	...
	case 0x97: /* TODO: EPA */
	case 0x98: /* TODO: SOS */
	case 0x99: /* TODO: SGCI */ break;
	case 0x9a: /* DECID -- Identify Terminal */
		ttywrite(vtiden, strlen(vtiden), 0);
		break;
	case 0x9b: /* TODO: CSI */
	case 0x9c: /* TODO: ST */ break;
...
int eschandle(uchar ascii)
{
	...
	case '>': /* DECPNM -- Normal keypad */
		...
		break;
	case '7': /* DECSC -- Save Cursor */ tcursor(CURSOR_SAVE); break;
	case '8': /* DECRC -- Restore Cursor */ tcursor(CURSOR_LOAD); break;
